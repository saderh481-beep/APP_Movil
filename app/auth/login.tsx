...
const s = StyleSheet.create({
  ...
  dotsError: { borderColor: Colors.danger, backgroundColor: Colors.dangerLight },
  ...
  dotFilled: { borderColor: Colors.guinda, backgroundColor: Colors.guinda },
  dotLast: { borderColor: Colors.dorado },
  dotError: { borderColor: Colors.danger },
  dotInner: { width: 16, height: 16, borderRadius: 8, backgroundColor: Colors.white },
